...
import project.time.tracker.domain.WorkDaySummaryCollection
import project.time.tracker.domain.WorkDaySummary
import project.time.tracker.service.ConsoleTableHelper.Companion.getCellString
import project.time.tracker.service.ConsoleTableHelper.Companion.getContentLine
import project.time.tracker.service.ConsoleTableHelper.Companion.getHorizontalSeparator
import project.time.tracker.upload.ProjectTimeCalculator
...
import project.time.tracker.util.DateTimeUtil.Companion.temporalToString
