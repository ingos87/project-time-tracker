...
class Init: CliktCommand(help="initializes App by writing custom properties to a file") {
    ...
    val timekeepingAppUrl by option("-t", "--timekeepingappurl", help="Url to time keeping app (e.g. URL to MyHRSelfService) landing page").default("https://url-to-time-keeping-app.com")
    val timekeepingAppLanguage by option("-l", "--timekeepingapplang", help="Language (EN,DE) of time keeping app").default("EN")
    val costAssessmentAppUrl by option("-a", "--costassessmentappurl", help="Url to project booking landing page").default("https://url-to-cost-assessment-app.com")
    val costAssessmentAppLanguage by option("-n", "--costassessmentapplang", help="Language (EN,DE) of project booking app").default("EN")
    ...
    override fun run() {
        ConfigService.createConfigFileWithParams(
            ...
            csvPath = csvPath,
            myHrSelfServiceUrl = timekeepingAppUrl,
            myHrSelfServiceLanguage = timekeepingAppLanguage,
            eTimeUrl = costAssessmentAppUrl,
            eTimeLanguage = costAssessmentAppLanguage,
