...
class CostAssessmentForecastTests : FunSpec({
    ...
    test("cost assessment works with forecast") {
        ...
        executeClockInWitArgs(arrayOf("-project=\"Meetings\"", "-ttownhalll","--datetime=2023-02-15 09:30"))
        ...
        executeClockInWitArgs(arrayOf("-project=\"Meetings\"", "-tf2ff",     "--datetime=2023-02-22 07:30"))
        executeClockInWitArgs(arrayOf("-project=\"Meetings\"", "-ttownhalll","--datetime=2023-02-22 09:00"))
        ...
        val input = mapOf<LocalDate, List<CostAssessmentPosition>>(
            ...
            LocalDate.parse("2023-02-22") to listOf(
                CostAssessmentPosition(Duration.parse("PT3H30M"), "Meetings", "", ""),
