...
class CostAssessmentTests : FunSpec({
    ...
    test("cost assessment is not possible if there is no config file") {
        ...
        val output = tapSystemOut {
            project.time.tracker.main(arrayOf("cost-assessment", "-d2023-01-02", "-e2023-01-08"))
        }
    ...
    test("cost assessment for standard week") {
        ...
        splitIgnoreBlank(output) shouldBe listOf(
            ...
            "│ Holidays                       │  8,00│      │      │      │      │      8,00              ",
            "├────────────────────────────────┼──────┼──────┼──────┼──────┼──────┤",
            "│ ProjectA                       │      │  4,00│ 11,00│      │  5,00│     20,00              ",
            "│   code                         │      │  4,00│  9,00│      │  5,00│            18,00       ",
            "│     EPP-007                    │      │  4,00│      │      │      │                    4,00",
            "│     EPP-008                    │      │      │  9,00│      │  5,00│                   14,00",
            "│   meeting                      │      │      │  2,00│      │      │             2,00       ",
            "├────────────────────────────────┼──────┼──────┼──────┼──────┼──────┤",
            "│ ProjectB                       │      │  2,00│      │      │      │      2,00              ",
            "│   code                         │      │  2,00│      │      │      │             2,00       ",
            ...
            "└────────────────────────────────┴──────┴──────┴──────┴──────┴──────┘",
            "│ total                          │  8,00│  9,00│ 11,00│  8,00│  7,00│     43,00              ",
            "NOOP mode. Uploaded nothing")
    }
