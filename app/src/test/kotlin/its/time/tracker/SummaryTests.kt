...
class SummaryTests : FunSpec({
    ...
    test("today's summary if working day is in progress") {
        ...
        executeClockInWitArgs(arrayOf<String>("-tEPP-123",  "--datetime=$todayString 04:45"))
        executeClockInWitArgs(arrayOf<String>("-tEDF-777",  "--datetime=$todayString 05:55"))
    ...
    test("monthly summary") {
        ...
        executeClockOutWitArgs(arrayOf<String>(             "--datetime=2022-11-04 21:30"))
        executeClockInWitArgs(arrayOf<String>("-tEDF-0815", "--datetime=2022-11-04 22:00"))
