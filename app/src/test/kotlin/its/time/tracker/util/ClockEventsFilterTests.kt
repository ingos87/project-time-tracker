...
class ClockEventsFilterTests : FunSpec({
    ...
    test("filter by month results in empty list if no events are relevant") {
        val input = listOf(
            ClockEvent(LocalDateTime.parse("2023-01-31T12:00"), EventType.CLOCK_IN, "n/a", "blubb", "epp-123"),
            ClockEvent(LocalDateTime.parse("2023-01-31T14:00"), EventType.CLOCK_OUT, "n/a", "", "epp-123"),
            ClockEvent(LocalDateTime.parse("2023-01-31T23:00"), EventType.CLOCK_IN, "n/a", "blubb", "epp-123"),
            ClockEvent(LocalDateTime.parse("2023-02-01T00:30"), EventType.CLOCK_OUT, "n/a", "", "epp-123"),

            ClockEvent(LocalDateTime.parse("2023-03-01T11:00"), EventType.CLOCK_IN, "n/a", "blubb", "epp-123"),
        )
    ...
    test("filter by month works") {
        val input = listOf(
            ...
            ClockEvent(LocalDateTime.parse("2023-02-04T05:00"), EventType.CLOCK_IN, "n/a", "blubb", "epp-123"),
            ClockEvent(LocalDateTime.parse("2023-02-04T13:00"), EventType.CLOCK_OUT, "n/a", "blubb", "epp-123"),
            ClockEvent(LocalDateTime.parse("2023-02-25T06:00"), EventType.CLOCK_IN, "n/a", "blubb", "epp-123"),
            ClockEvent(LocalDateTime.parse("2023-02-25T13:00"), EventType.CLOCK_OUT, "n/a", "blubb", "epp-123"),
            ClockEvent(LocalDateTime.parse("2023-02-28T22:00"), EventType.CLOCK_IN, "n/a", "blubb", "epp-123"),
            ClockEvent(LocalDateTime.parse("2023-03-01T00:15"), EventType.CLOCK_OUT, "n/a", "blubb", "epp-123"),
